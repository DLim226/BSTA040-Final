...
st.pyplot(fig)
st.text("The histogram shows the frequency of the ILI(Influenza- Like- Illnesses) percentage for the state that the user picked. The x-axis is the ILI percentage and the y-axis is the frequency(how much the percentage appeared over time). The exponential curve is used to show the distribution of the histogram.")
